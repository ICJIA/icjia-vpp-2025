...
import TextCenteredImage from "../../components/content/TextCenteredImage.astro";
...
<TextCenteredImage src="/images/PPT_circles.webp" alt="Where Violence Prevention Efforts Occur: the social-ecological model (text version below)" caption="Figure 1. Social-ecological model" />

<details id="figure-1-text-version" class="figure-text-version">
<summary>Text version of Figure 1</summary>
...
The figure draws the four levels as nested circles, from outermost to innermost: Society, Community, Relationships, Individual.
...
<TextCenteredImage src="/images/PPT_pyramid.webp" alt="Image: When Violence Prevention Efforts Occur" caption="Figure 2. Primary, secondary, and tertiary prevention efforts" />

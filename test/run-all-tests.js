...
const TEST_DESCRIPTIONS = {
  ...
  "should default to dark theme": "Verifies the theme composable always defaults to dark mode on initialization. This ensures consistent behavior across sessions for the Statewide Violence Prevention Plan portal.",
  "should provide theme reactive ref": "Confirms the composable returns a reactive theme ref that UI components can watch for changes. Theme changes trigger immediate re-renders.",
  "should provide isDark computed property": "Verifies the isDark computed returns boolean for conditional styling in templates without string comparison.",
  "should provide toggleTheme function": "Confirms toggleTheme function is available for switching between light and dark themes.",
  "should accept \"light\" as valid theme": "Verifies 'light' is accepted as a valid theme value by the setTheme function.",
  "should accept \"dark\" as valid theme": "Confirms 'dark' is accepted as a valid theme value by the setTheme function.",
  "should reject invalid theme values": "Verifies invalid theme values like 'blue' or 'auto' are rejected by the setTheme function.",
  "should reject empty string as theme": "Confirms empty string is not accepted as a valid theme value.",
  "should reject null as theme": "Verifies null is not accepted as a valid theme value.",
  "should toggle from dark to light": "Confirms toggle functionality correctly switches from dark to light theme.",
  "should toggle from light to dark": "Verifies toggle functionality correctly switches from light to dark theme.",
  "should maintain toggle consistency": "Confirms multiple toggle calls maintain consistent alternating behavior.",
  "should use sessionStorage for theme persistence": "Verifies theme uses sessionStorage (not localStorage) for session-only persistence.",
  "should not persist across browser sessions": "Confirms theme resets to dark on new browser session as per design decision.",
  "should update data-theme attribute on document": "Verifies the composable updates the document's data-theme attribute for CSS theming.",
  "should support WCAG 2.1 AA compliant themes": "Confirms both light and dark themes meet WCAG 2.1 AA contrast requirements.",
  "should return theme ref": "Verifies the composable returns the theme reactive ref.",
  "should return isDark computed": "Confirms the composable returns the isDark computed property.",
  "should return setTheme function": "Verifies the composable returns the setTheme function for direct theme setting.",
  "should return toggleTheme function": "Confirms the composable returns the toggleTheme function.",
  "should return syncWithVuetify function": "Verifies the composable returns syncWithVuetify for Vuetify theme integration.",
  "should return initializeTheme function": "Confirms the composable returns initializeTheme for initial theme setup.",

  // useAnnouncer Composable Tests
  "should return announcer interface": "Verifies useAnnouncer returns object with announce function. This interface provides ARIA live region announcements for accessibility.",
  "should provide announcePolite ref": "Confirms announcePolite reactive ref is available for polite (non-interrupting) screen reader announcements.",
  "should provide announceAssertive ref": "Verifies announceAssertive reactive ref is available for urgent, interrupting screen reader announcements.",
  "should provide announce function": "Confirms the announce function is callable for programmatic announcements during dynamic content changes.",
  "should default to polite priority": "Verifies announcements use polite priority by default, which doesn't interrupt screen reader users.",
  "should clear before announcing for screen reader detection": "Confirms announcements are cleared before new announcement to ensure screen readers detect the change.",
  "should support assertive priority": "Verifies assertive priority is available for urgent announcements that should interrupt the user.",
  "should use assertive for interrupting announcements": "Confirms assertive mode interrupts screen reader to announce critical information immediately.",
  "should provide announceLoading method": "Verifies dedicated loading announcement method is available for async operation feedback.",
  "should provide announceSuccess method": "Confirms success announcement method is available for positive feedback to users.",
  "should provide announceError method": "Verifies error announcement method is available for alerting users to problems.",
  "should provide announceNavigation method": "Confirms navigation announcement method notifies users of page changes.",
  "should handle loading announcements with context": "Verifies loading announcements can include context like 'Loading search results...'.",
  "should handle success announcements with context": "Confirms success announcements can include context like 'Form submitted successfully'.",
  "should handle error announcements with context": "Verifies error announcements can include descriptive context about what went wrong.",
  "should handle navigation announcements with additional info": "Confirms navigation announcements can include page title and other context.",
  "should handle empty messages": "Verifies empty string announcements are handled gracefully without errors.",
  "should handle long messages": "Confirms long announcement messages are handled without truncation issues.",
  "should handle special characters": "Verifies announcements with special characters like quotes and ampersands work correctly.",
  "should support ARIA live region polite mode": "Confirms polite mode works correctly with ARIA live region specifications.",
  "should support ARIA live region assertive mode": "Verifies assertive mode works correctly with ARIA live region specifications.",
  "should clear announcements to trigger screen reader detection": "Confirms the clear-before-announce pattern ensures screen readers detect all announcements.",
  "should return all expected properties": "Verifies the composable returns all expected properties: announce, announcePolite, announceAssertive, etc.",

  // useReportNavigation Composable Tests
  "should normalize paths with trailing slashes": "Verifies path normalization removes trailing slashes for consistent route matching in navigation.",
  "should handle root path": "Confirms root path '/' is handled correctly without being normalized to empty string.",
  "should handle empty path": "Verifies empty path input is handled gracefully with appropriate fallback behavior.",
  "should handle double slashes": "Confirms multiple consecutive slashes are normalized to single slashes.",
  "should include previous page data": "Verifies navigation data includes previous page title, path, and summary.",
  "should include next page data": "Confirms navigation data includes next page title, path, and summary.",
  "should include current index": "Verifies navigation data includes current page index in the report sequence.",
  "should include total pages count": "Confirms navigation data includes total number of report pages.",
  "should return null for previous on first page": "Verifies first page correctly returns null for previous navigation.",
  "should return null for next on last page": "Confirms last page correctly returns null for next navigation.",
  "should return both previous and next for middle pages": "Verifies middle pages have both previous and next navigation available.",
  "should identify report pages correctly": "Confirms isReportPage correctly identifies pages that are part of the plan.",
  "should identify non-report pages correctly": "Verifies isReportPage returns false for non-plan pages like /contact.",
  "should include summary for navigation context": "Confirms page summaries are included for navigation tooltips.",
  "should provide default summary when none is specified": "Verifies default summary is provided when page has no explicit summary.",
  "should provide aria labels for navigation": "Confirms ARIA labels are provided for accessibility compliance.",
  "should provide tooltips for navigation elements": "Verifies tooltip content is available for navigation buttons.",
  "should provide getNavigationData function": "Confirms composable exports getNavigationData function.",
  "should provide isReportPage function": "Verifies composable exports isReportPage function.",
  "should provide extractReportPages function": "Confirms composable exports extractReportPages function.",
  "should provide reportPages computed property": "Verifies composable exports reportPages computed property.",
  "should provide totalReportPages computed property": "Confirms composable exports totalReportPages computed property.",
  "should cache extracted report pages for performance": "Verifies report pages are cached to avoid repeated extraction.",
  "should handle isFirstPage flag correctly": "Confirms isFirstPage flag is set correctly based on position.",
  "should handle isLastPage flag correctly": "Verifies isLastPage flag is set correctly based on position.",

  // useReferences Composable Tests
  "should provide getReference function": "Verifies getReference function is available for fetching individual reference citations by ID.",
  "should provide getMultipleReferences function": "Confirms batch reference retrieval is supported for efficiency when multiple citations are needed.",
  "should provide formatMultipleReferences function": "Verifies formatter function exists for rendering multiple references with proper citation formatting.",
  "should trim whitespace from reference IDs": "Confirms reference IDs are trimmed of leading/trailing whitespace before lookup.",
  "should handle empty reference ID": "Verifies empty string reference ID is handled gracefully without errors.",
  "should handle null reference ID": "Confirms null reference ID is handled gracefully without throwing errors.",
  "should split multiple IDs by comma": "Verifies comma-separated reference IDs are correctly parsed into individual IDs.",
  "should handle IDs with extra whitespace": "Confirms extra whitespace around comma-separated IDs is properly trimmed.",
  "should handle single ID": "Verifies single reference ID (not comma-separated) is handled correctly.",
  "should filter out empty strings after splitting": "Confirms empty strings from double commas are filtered from ID array.",
  "should expect shortCitation property": "Verifies reference objects have shortCitation for inline citations.",
  "should expect fullCitation property": "Confirms reference objects have fullCitation for complete references.",
  "should expect url property when available": "Verifies reference objects include URL for web-based references.",
  "should expect type property for reference categorization": "Confirms reference objects have type field for categorization.",
  "should return \"References not found\" for empty array": "Verifies formatMultipleReferences returns appropriate message for empty input.",
  "should return single citation for single reference": "Confirms single reference formatting returns just the citation without numbering.",
  "should format multiple references with numbering": "Verifies multiple references are formatted with sequential numbers.",
  "should use shortCitation as fallback when fullCitation is missing": "Confirms shortCitation is used when fullCitation is not available.",
  "should handle invalid reference data format": "Verifies invalid data formats are handled gracefully with fallback.",
  "should return null for not found reference": "Confirms null is returned when reference ID doesn't exist in data.",
  "should return empty array when loading multiple references fails": "Verifies empty array fallback when batch loading fails.",
  "should fetch fresh data on each call": "Confirms references are fetched fresh without caching issues.",
  "should fetch from /data/references.json endpoint": "Verifies correct endpoint is used for reference data loading.",

  // useLazyComponent Composable Tests
  "should have default rootMargin of 100px": "Verifies the default rootMargin is 100px for preloading content before it enters the viewport.",
  "should have default threshold of 0.1": "Confirms the default intersection threshold is 0.1 for triggering lazy load.",
  "should default to observe once": "Verifies once is true by default, meaning components load only on first intersection.",
  "should allow custom rootMargin": "Confirms custom rootMargin values can be provided for different preload distances.",
  "should allow custom threshold values": "Verifies custom threshold values are accepted for fine-tuned intersection detection.",
  "should validate threshold is between 0 and 1": "Confirms threshold values must be valid intersection ratios between 0 and 1.",
  "should accept custom component name for debugging": "Verifies componentName option enables meaningful debug logging.",
  "should provide isVisible ref": "Confirms isVisible reactive ref is returned for controlling component visibility.",
  "should provide targetRef for element binding": "Verifies targetRef is provided for template ref binding to observed element.",
  "should initialize isVisible as false": "Confirms isVisible starts as false before component enters viewport.",
  "should initialize targetRef as null": "Verifies targetRef is null before component is mounted.",
  "should set isVisible to true when element intersects": "Confirms IntersectionObserver correctly sets isVisible when element is visible.",
  "should not change isVisible when element is not intersecting": "Verifies isVisible remains false when element is outside viewport.",
  "should unobserve after first intersection when once is true": "Confirms observer disconnects after first load when once is true.",
  "should continue observing when once is false": "Verifies continued observation for elements that may re-enter viewport.",
  "should handle missing IntersectionObserver gracefully": "Confirms fallback to immediate loading when IntersectionObserver is unsupported.",
  "should setup observer on component mount": "Verifies observer is created in onMounted lifecycle hook.",
  "should disconnect observer on component unmount": "Confirms cleanup in onUnmounted prevents memory leaks.",
  "should skip setup if no target element": "Verifies graceful handling when targetRef is not set.",
  "should skip setup during SSR": "Confirms observer is not created during server-side rendering.",
  "should load immediately if observer setup fails": "Verifies fallback behavior sets isVisible to true on error.",
  "should log errors to console on setup failure": "Confirms errors are logged for debugging when setup fails.",
  "should handle null targetRef gracefully": "Verifies no errors thrown when targetRef is null.",
  "should use rootMargin for early loading": "Confirms rootMargin enables preloading before element fully enters viewport.",
  "should only load visible components": "Verifies deferred loading improves initial page performance.",
  "should reduce initial bundle execution": "Confirms lazy loading reduces JavaScript execution on page load.",

  // useConsoleLogger Composable Tests
  "should return logger interface": "Verifies useConsoleLogger returns object with log function and controls.",
  "should provide isEnabled ref": "Confirms isEnabled reactive ref controls global logging state.",
  "should provide enable function": "Verifies enable function turns on console logging globally.",
  "should provide disable function": "Confirms disable function turns off console logging globally.",
  "should provide toggle function": "Verifies toggle function switches logging state between enabled and disabled.",
  "should provide logUI function": "Confirms logUI function logs UI events with blue color coding.",
  "should provide logRoute function": "Verifies logRoute function logs navigation events with purple color.",
  "should provide logTheme function": "Confirms logTheme function logs theme changes with dark purple color.",
  "should provide logLifecycle function": "Verifies logLifecycle function logs component lifecycle with green color.",
  "should provide logSuccess function": "Confirms logSuccess function logs successful operations with green color.",
  "should provide logWarning function": "Verifies logWarning function logs warnings with orange color.",
  "should provide logError function": "Confirms logError function logs errors with red color for visibility.",
  "should provide logAPI function": "Verifies logAPI function logs API calls with teal color.",
  "should provide logPerf function": "Confirms logPerf function logs performance metrics with yellow color.",
  "should provide COLORS object": "Verifies COLORS constant exports all category color definitions.",
  "should have UI color defined": "Confirms UI category has blue (#3498db) color for visual distinction.",
  "should have route color defined": "Verifies route category has purple (#9b59b6) color.",
  "should have theme color defined": "Confirms theme category has dark purple (#8e44ad) color.",
  "should have lifecycle color defined": "Verifies lifecycle category has green (#2ecc71) color.",
  "should have success color defined": "Confirms success category has dark green (#27ae60) color.",
  "should have warning color defined": "Verifies warning category has orange (#f39c12) color.",
  "should have error color defined": "Confirms error category has red (#e74c3c) color for visibility.",
  "should have API color defined": "Verifies API category has teal (#1abc9c) color.",
  "should have perf color defined": "Confirms performance category has yellow (#f1c40f) color.",
  "should have default color defined": "Verifies default category has gray (#7f8c8d) fallback color.",
  "should enable logging when enable is called": "Confirms enable() sets isEnabled.value to true.",
  "should disable logging when disable is called": "Verifies disable() sets isEnabled.value to false.",
  "should toggle logging state": "Confirms toggle() switches between enabled and disabled states.",
  "should not log when disabled": "Verifies log calls are suppressed when isEnabled is false.",
  "should accept message parameter": "Confirms log function accepts message string parameter.",
  "should accept optional data parameter": "Verifies additional data objects can be logged for debugging.",
  "should handle undefined data": "Confirms undefined data parameter doesn't cause errors.",
  "should handle null data": "Verifies null data parameter is handled gracefully.",
  "should handle array data": "Confirms array data is properly logged to console.",
  "should share state across multiple calls": "Verifies singleton pattern maintains consistent state across imports.",
  "should maintain consistent color constants": "Confirms COLORS object is identical across all composable instances.",
  "should use default color for unknown categories": "Verifies unknown categories fall back to default gray color.",

  // Navigation E2E Tests
  "should have home route defined": "Verifies home route '/' is configured with name 'index'.",
  "should have plan routes defined": "Confirms all plan section routes are properly defined.",
  "should have resources route defined": "Verifies '/resources' route is configured.",
  "should have contact route defined": "Confirms '/contact' route is properly configured.",
  "should have accessibility routes defined": "Verifies all three accessibility page routes exist.",
  "should have legal routes defined": "Confirms privacy and terms routes are configured.",
  "should have main navigation items": "Verifies main menu has Home, Plan, Resources, Contact items.",
  "should have sidebar navigation for plan sections": "Confirms sidebar contains all plan section navigation links.",
  "should have footer navigation items": "Verifies footer contains legal and accessibility links.",
  "should provide next/previous navigation between sections": "Confirms sequential navigation through plan sections.",
  "should not have previous on first section": "Verifies first section correctly hides previous button.",
  "should not have next on last section": "Confirms last section correctly hides next button.",
  "should have smooth scroll configured": "Verifies smooth scroll behavior for page navigation.",
  "should scroll to top on route change": "Confirms page scrolls to top when navigating between routes.",
  "should handle hash navigation": "Verifies anchor link navigation scrolls to correct section.",
  "should have error page configured": "Confirms error.vue exists for 404 handling.",
  "should redirect unknown routes to error page": "Verifies unknown routes display error page.",
  "should show breadcrumbs on nested pages": "Confirms breadcrumb navigation appears on plan pages.",
  "should have correct hierarchy": "Verifies breadcrumb levels increase progressively.",

  // Accessibility E2E Tests
  "should have main landmark": "Verifies main content has proper ARIA landmark role.",
  "should have header landmark": "Confirms header element has proper landmark role.",
  "should have footer landmark": "Verifies footer element has proper ARIA role.",
  "should have navigation landmark": "Confirms navigation elements have proper landmark roles.",
  "should have complementary landmark for sidebar": "Verifies sidebar uses complementary landmark role.",
  "should have skip to main content link": "Confirms skip link exists for keyboard navigation.",
  "should have skip to navigation link": "Verifies skip link to navigation is available.",
  "should be visible on focus": "Confirms skip links become visible when focused.",
  "should have visible focus indicators": "Verifies all interactive elements show focus outline.",
  "should manage focus on route change": "Confirms focus moves to main content on navigation.",
  "should trap focus in modal dialogs": "Verifies modal focus trap prevents tabbing outside.",
  "should restore focus on modal close": "Confirms focus returns to trigger element after modal closes.",
  "should support tab navigation": "Verifies all interactive elements are tabbable.",
  "should support arrow key navigation in menus": "Confirms arrow keys work for menu navigation.",
  "should support escape to close overlays": "Verifies Escape key closes modals and dropdowns.",
  "should support enter/space for activation": "Confirms Enter and Space activate buttons and links.",
  "should have announcer for dynamic content": "Verifies ARIA live region exists for announcements.",
  "should announce page navigation": "Confirms screen readers are notified of page changes.",
  "should announce search results": "Verifies search result count is announced.",
  "should announce form validation errors": "Confirms form errors are announced to screen readers.",
  "should have alt text for informative images": "Verifies images have descriptive alt attributes.",
  "should have empty alt for decorative images": "Confirms decorative images have empty alt text.",
  "should have captions for videos": "Verifies video content includes captions.",
  "should meet WCAG AA contrast ratio (4.5:1 for normal text)": "Confirms text color contrast meets WCAG AA standard.",
  "should meet WCAG AA contrast ratio (3:1 for large text)": "Verifies large text meets minimum contrast ratio.",
  "should not rely solely on color to convey information": "Confirms multiple cues are used beyond color.",
  "should work in high contrast mode": "Verifies site works with Windows High Contrast mode.",
  "should have labels for all form inputs": "Confirms all form fields have associated labels.",
  "should have error messages associated with inputs": "Verifies error messages are linked via aria-describedby.",
  "should have required field indicators": "Confirms required fields are properly marked.",
  "should group related form fields": "Verifies fieldsets group related inputs.",
  "should have one h1 per page": "Confirms each page has exactly one h1 heading.",
  "should have proper heading hierarchy": "Verifies heading levels don't skip (h1 to h3).",
  "should have descriptive heading text": "Confirms headings clearly describe section content.",
  "should have proper table headers": "Verifies data tables have th elements with scope.",
  "should have captions for data tables": "Confirms tables have descriptive captions.",
  "should have row headers where appropriate": "Verifies row headers are used for complex tables.",
  "should support light and dark themes": "Confirms both themes are available for user preference.",
  "should respect user preference for color scheme": "Verifies prefers-color-scheme is respected.",
  "should maintain accessibility in both themes": "Confirms accessibility is maintained across themes.",

  // Content E2E Tests
  "should have executive summary section": "Verifies executive summary is part of plan structure.",
  "should have four priority sections": "Confirms all four priority areas are defined.",
  "should have conclusion section": "Verifies conclusion section exists in plan.",
  "should have organizational highlights": "Confirms organizational highlights page is available.",
  "should render markdown to HTML": "Verifies markdown content is converted to HTML.",
  "should process footnotes/references": "Confirms reference citations are properly processed.",
  "should render tables correctly": "Verifies markdown tables render as HTML tables.",
  "should render lists correctly": "Confirms ordered and unordered lists render properly.",
  "should render blockquotes correctly": "Verifies blockquote styling is applied.",
  "should render PageTitleSection component": "Confirms page title component displays correctly.",
  "should render TextWrapImage component": "Verifies text wrap image component works.",
  "should render ReportNavigation component": "Confirms report navigation buttons display.",
  "should render ReferenceTooltip component": "Verifies reference tooltips appear on hover.",
  "should have news items": "Confirms news content is available.",
  "should display news items in chronological order": "Verifies news is sorted by date.",
  "should format news dates correctly": "Confirms dates display in readable format.",
  "should have plan PDF available": "Verifies downloadable PDF is accessible.",
  "should have download button component": "Confirms download button is displayed.",
  "should have proper file MIME types": "Verifies correct content-type headers.",
  "should have external resources listed": "Confirms resources page has external links.",
  "should have resource categories": "Verifies resources are organized by category.",
  "should have external link indicators": "Confirms external links show visual indicator.",
  "should have contact information": "Verifies contact details are displayed.",
  "should have feedback form": "Confirms feedback form is available.",
  "should have privacy policy": "Verifies privacy policy page exists.",
  "should have terms of use": "Confirms terms of use page exists.",
  "should have accessibility statement": "Verifies accessibility statement page exists.",
  "should lazy load images": "Confirms images use lazy loading for performance.",
  "should show loading spinner for images": "Verifies loading state is shown for images.",
  "should have fallback for failed images": "Confirms broken images show fallback content.",
  "should have search interface": "Verifies search functionality is available.",
  "should search across plan content": "Confirms search covers all plan sections.",
  "should highlight search matches": "Verifies matched text is highlighted.",
  "should provide search suggestions": "Confirms search provides helpful suggestions.",
};
...
<body>
  ...
  <div class="container">
    ...
    <h1>🧪 Statewide Violence Prevention Plan for Illinois: 2025-2029 - Unit and E2E Tests Results Report</h1>
    <p class="meta" style="margin-top: 0.5rem; margin-bottom: 1rem;">Comprehensive unit and E2E test results for composables, utilities, and components</p>
    <div class="meta">
